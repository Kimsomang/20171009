	...
	<div id="header_navi">
		<form action="control" method="post">
			...
			<c:if test="${sessionScope.memberGrade eq 'A'}">
				<input type="image" name="action" value="manage" src="img/img_navi_main.png" class="navi" title="메인페이지">
			...
			<c:if test='${not empty sessionScope.memberId}'>
				<input type="image" name="action" value="serviceCategories" src="img/img_navi_main.png" class="navi" title="메인페이지">
